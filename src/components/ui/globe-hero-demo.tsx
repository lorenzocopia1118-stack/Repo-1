...
export default function DotGlobeHeroDemo() {
  return (
    ...
    >
      ...
      <div className="absolute bottom-1/4 right-1/4 w-64 h-64 bg-primary/[0.03] rounded-full blur-3xl animate-pulse" />
        ...
        >
          <motion.button
            whileHover={{
              scale: 1.05,
              boxShadow:
                "0 20px 40px rgba(0,0,0,0.2), 0 0 25px rgba(27,92,240,0.35)",
              y: -2,
            }}
            whileTap={{ scale: 0.98 }}
          ...
          <motion.button
            whileHover={{
              scale: 1.05,
              backgroundColor: "rgba(27,92,240,0.06)",
              borderColor: "#1b5cf0",
              boxShadow:
                "0 15px 30px rgba(0,0,0,0.1), 0 0 15px rgba(27,92,240,0.15)",
              y: -2,
            }}
            whileTap={{ scale: 0.98 }}
